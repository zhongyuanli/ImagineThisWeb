    ...
    <div>
      <div className="container d-none d-xl-block d-lg-block d-xl-none d-xl-block d-md-block d-lg-none">
        ...
        <div id="instruction-div" className="">
          ...
          <ol className="pc-ordered-list">
            ...
            <li>
              Open your device's built-in camera app and point it at the QR code
              on this page
            </li>
            <li>
      ...
      <div className="container d-block d-sm-none d-none d-sm-block d-md-none">
        ...
        <div className="mobile_instruction-div">
          ...
          <p className="mobile-ordered-p mobile-ordered-list mobile-device-name">
            Android User:
          </p>

          <ol className="mobile-ordered-list">
            <li>
              Install the "<a href="https://expo.io/tools">Expo Go</a>" on app
              on your mobile device
            </li>
            <li>
              Click the QR code at the bottom of the screen. This should open
              the expo app
            </li>
          ...
          <ol className="mobile-ordered-list">
            ...
            <li>
              Login into the "Expo Go" application using the following
              account(Username:imaginethistest Password:ImagineThisUCL2021)
            </li>
            <li>
              Click the QR code at the bottom of the screen. This should open
              the expo app
