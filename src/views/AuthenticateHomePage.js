              ...
              <div className="auth-form">
                <Tabs defaultActiveKey="auth-token" id="uncontrolled-tab-example">
                  <Tab eventKey="auth-token" title="Authenticate with Token">
                    ...
                    <p className="mt-2">
                      <a href="https://www.figma.com/developers/api#access-tokens" target="_blank" rel="noopener noreferrer">Click here</a>
                      {' '}
                      to learn how to generate your Figma access token and project ID
                    </p>
                    <input
                  ...
                  <Tab eventKey="Oauth2" title="Oauth 2.0 Authentication">
                    ...
                    <p className="mt-2">
                      You will be redirected to Figma's authentication page where you will be able to log in and get access to you project, using the Oauth 2.0 protocol.
                      <a href="https://oauth.net/2/" target="_blank" rel="noopener noreferrer">Click here</a>
                      {' '}
                      to get more detailed information about this authentication method.
                    </p>
                    <button
